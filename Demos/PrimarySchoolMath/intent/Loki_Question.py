...
def getResult(pattern, utterance, args, inputUtterance, questionDICT):
    ...
    if utterance == "[小湘]比[小強]多幾[張][貼紙]":
        # write your code here
        pass

    if utterance == "[棒虎]比[小福]多得幾分":
        # write your code here
        pass

    if utterance == "[媽媽]比[黃阿姨]多買幾[個][月餅]":
        # write your code here
        pass

    if utterance == "[姊姊]比[哥哥]少買幾[枝]":
        # write your code here
        pass
    ...
    if utterance == "沒有捉到的[小朋友]有多少[個]":
        # write your code here
        pass

    if utterance == "再過幾[年][我]就[18]歲了":
        # write your code here
        pass

    if utterance == "[姊姊][今年]幾歲":
        # write your code here
        pass
    ...
    if utterance == "[昨天]比[今天]少摺了幾[隻][紙鶴]":
        # write your code here
        pass
