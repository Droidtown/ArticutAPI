...
inputSTR = "國軍退除役官兵輔導委員會簡稱退輔會。 "
resultDICT = atc.parse(inputSTR, userDefinedDictFILE="../../Public_UserDefinedDict/KNOWLEDGE_gov.json")
...
print([result.replace("UserDefined", tagName) for result in resultDICT["result_pos"]])
print("=====================")