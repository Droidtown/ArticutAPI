...
class TaiwanAddressAnalizer:
    def __init__(self, locale=None):
        ...
        self.TWaddPatDICT = {"countyPat"      : "[^\s][^市]縣",
                             ...
                             "alleyPat"       : "(國中|市場|新市.|([^縣市區鄉鎮里村路]{1,2}|鐵路)[零一二三四五六七八九十廿卅百０-９\d]*?|\s?[零一二三四五六七八九十廿卅百０-９\d]*?)\s?巷([零一二三四五六七八九十廿卅百０-９\d]*?\s?弄)?",
                             "numberPat"      : "(\s?[零一二三四五六七八九十廿卅百０-９\d]*?\s?[之\-]\s?)?\s?[零一二三四五六七八九十廿卅百０-９\d]*?\s?號([之\-]\s?[零一二三四五六七八九十廿卅百０-９\d]+?)?",
                             "floorPat"       : "\s?[零一二三四五六七八九十廿卅百０-９\d]*?\s?[fF樓]([之\-]\s?[零一二三四五六七八九０-９\d]+)?",
                             "roomPat"        : "\s?([a-zA-Z\d０-９]+?)\s?(室?$)"}
