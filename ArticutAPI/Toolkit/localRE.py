...
class TaiwanAddressAnalizer:
    def __init__(self, locale=None):
        ...
        self.TWaddPatDICT = {"countyPat"      : "[^\s][^市]縣",
                             ...
                             "roadPat"        : "市府路|市[政場]([北南中]|[1-7一二三四五六七]){0,2}路|市港[^\s]路|[新環村盛果]市[^\s]?[路街]|市民大道|市宅街|[埔菜美元西]市[路街]|(?<=[縣市區鄉鎮里村鄰])[^市區鄉鎮村路及、，]{1,4}([路街]|大道)",
                             "sectionPat"     : "\s?[\d零一二三四五六七八九十廿卅百０-９]*?\s?段",
                             "alleyPat"       : "(國中|市場|新市.|([^縣市區鄉鎮里村路]{1,2}|鐵路)[\d零一二三四五六七八九十廿卅百０-９]*?|\s?[\d零一二三四五六七八九十廿卅百０-９]*?)\s?巷([\d零一二三四五六七八九十廿卅百０-９]*?\s?弄)?",
                             "numberPat"      : "(\s?[\d零一二三四五六七八九十廿卅百０-９]*?\s?[之\-]\s?)?\s?[\d零一二三四五六七八九十廿卅百０-９]*?\s?號([之\-]\s?[\d零一二三四五六七八九十廿卅百０-９]+?)?",
                             "floorPat"       : "\s?[\d零一二三四五六七八九十廿卅百０-９]*?\s?[fF樓]([之\-]\s?[\d零一二三四五六七八九０-９]+?)?",
                             "roomPat"        : "\s?([a-zA-Z\d]*?)\s?(室|$)",
                             "0-2":"{0,2}",
                             "1-4":"{1,4}"}
